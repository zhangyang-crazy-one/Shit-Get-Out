...
methodology_profile_ref: ".claude/sgo/config/methodology-overrides/tech-paper.json"
...
research_strategy:
  ...
  degradation_note: "当 Web 搜索不可用时，完全依赖 Claude 自身知识完成调研，在报告中标注'基于 Claude 知识，未进行 Web 验证'。科技论文对文献引用要求极高，建议在搜索可用时尽量多搜索"
